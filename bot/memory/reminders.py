...
class ReminderService:
    ...
    def __init__(self, storage_path: str = "data/reminders"):
        ...
        self.message_templates = {
            'follow_up_1h': [
                "{name}, актуально? Могу прислать 2–3 лучших варианта под ваш запрос.",
                "Есть время посмотреть варианты автоматизации для вашего {business}?",
                "{name}, подготовила несколько решений. Актуально сейчас?"
            ],
            'follow_up_6h': [
                "Подошли свободные окна на демо-показ: 18:00 сегодня или 11:00 завтра.",
                "{name}, появилось решение со скидкой в вашей вилке. Предложить?",
                "Есть интересное решение для автоматизации {business_sphere}. Посмотрим?"
            ],
            'follow_up_12h': [
                ...
                "Завтра последний день акции на комплексное решение. Интересно?"
            ],
            'follow_up_72h': [
                ...
                "Если ситуация изменится и понадобится автоматизация — обращайтесь!"
            ],
            'demo_reminder': [
    ...
    async def generate_reminder_message(self, reminder: ReminderTask, 
        ...
        try:
            ...
            templates = self.message_templates.get(template_type, [
                "Напоминание о вашем запросе на автоматизацию. Актуально?"
            ])
            ...
            return "Напоминание о вашем запросе на автоматизацию. Актуально?"
